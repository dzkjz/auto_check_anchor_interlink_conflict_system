...
class crawler:
    ...
    def __pull_news_result__(self):
        # 获取页面数量
        entry_url_news = 'https://www.kucoin.com/news'
        selector_pagination = 'li[data-item="page"]'
        self.__driver__.get(entry_url_news)
        ...
        for index in range(all_page_counts):
            index += 1
            news_pagination_url = entry_url_news + f"/{index}"
            # 收集到列表中
        ...
        def get_article_urls_in_pagenation(pagenation_url, articles, driver: WebDriver):
        ...
        while len(all_pagenations_to_crawl) > 0:
            ...
            for pagenation in pagenations:
                ...
                t = Thread(target=get_article_urls_in_pagenation, args=(pagenation, articles, driver))
                t.start()
                threads.append(t)
            for t in threads:
                t.join()
    ...
    def pull_source_code(self):
        ...
        def pull_news_page_details_source_code(driver: WebDriver, article_url: str, parent_url: str):
        ...
        while len(aus_copy) > 0:
            ...
            for aut in auts:
                ...
                t = Thread(target=pull_news_page_details_source_code,
